...
public class Main {
    public static void main(String[] args) {
        ...
        String kullaniciAdi ="Kursat", password = "Kursat123456", userName, userPassw, newPassword;
        byte choise;
        ...
        if(userName.equals(kullaniciAdi) && userPassw.equals(password)){
            System.out.println("Kullanıcı Adı ve Şifreniz Doğru, Başarılı Giriş Yaptınız Kürşat bey");
